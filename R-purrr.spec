...
Version  : 1.0.4
Release  : 62
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/purrr_1.0.4.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/purrr_1.0.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738795158
...
/usr/lib64/R/library/purrr/tests/testthat/_snaps/every-some-none.md
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/purrr/libs/purrr.so
/V4/usr/lib64/R/library/purrr/libs/purrr.so
