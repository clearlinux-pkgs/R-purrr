...
Version  : 0.3.5
Release  : 51
URL      : https://cran.r-project.org/src/contrib/purrr_0.3.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/purrr_0.3.5.tar.gz
Summary  : Functional Programming Tools
Group    : Development/Tools
License  : GPL-3.0
Requires: R-purrr-lib = %{version}-%{release}
Requires: R-purrr-license = %{version}-%{release}
Requires: R-magrittr
Requires: R-rlang
...
%package license
Summary: license components for the R-purrr package.
Group: Default

%description license
license components for the R-purrr package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665067733

%install
export SOURCE_DATE_EPOCH=1665067733
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/R-purrr
cp %{_builddir}/purrr/LICENSE %{buildroot}/usr/share/package-licenses/R-purrr/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
export LANG=C.UTF-8
...
/usr/share/package-licenses/R-purrr/8624bcdae55baeef00cd11d5dfcfa60f68710a02
