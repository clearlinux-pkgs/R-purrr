...
Version  : 1.0.0
Release  : 52
URL      : https://cran.r-project.org/src/contrib/purrr_1.0.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/purrr_1.0.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671560973
